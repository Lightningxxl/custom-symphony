defmodule SymphonyElixir.Workflow do
  @moduledoc """
  Loads shared Symphony config plus builder/planner/auditor documents from a
  repository root.
  """
  ...
  def set_repo_root(path) when is_binary(path) do
    ...
    Application.put_env(:symphony_elixir, :repo_root, expanded_path)
  ...
  def config_file_path do
    case Application.get_env(:symphony_elixir, :config_file_path) do
  ...
  def planner_file_path do
    case Application.get_env(:symphony_elixir, :planner_file_path) do
      path when is_binary(path) ->
        path
  ...
  def auditor_file_path do
    case Application.get_env(:symphony_elixir, :auditor_file_path) do
      path when is_binary(path) ->
        path
  ...
  def set_workflow_file_path(path) when is_binary(path) do
    ...
    Application.put_env(:symphony_elixir, :repo_root, Path.dirname(expanded_path))
    Application.delete_env(:symphony_elixir, :config_file_path)
    Application.delete_env(:symphony_elixir, :planner_file_path)
    Application.delete_env(:symphony_elixir, :auditor_file_path)
    maybe_reload_store()
