defmodule SymphonyElixir.FeishuTaskAdapterTest do
  ...
  setup do
    ...
    previous_client = Application.get_env(:symphony_elixir, :feishu_task_client)
    Application.put_env(:symphony_elixir, :feishu_task_client, FakeTaskClient)
    ...
    on_exit(fn ->
      ...
      if is_nil(previous_client) do
        Application.delete_env(:symphony_elixir, :feishu_task_client)
      else
        Application.put_env(:symphony_elixir, :feishu_task_client, previous_client)
      end
    end)
